        ...
        <div>
            <div>
                <nav className="flex justify-between py-1 items-center bg-white">
                    ...
                    <h1 className="text-xl text-gray-800 font-bold absolute left-20">Company Name</h1>
                    <div className="flex items-center">
                        ...
                        <ul className="flex items-center space-x-6">
                            <Link className="font-semibold text-gray-700 cursor-pointer" to='/about'><li>About</li></Link>
                            <Link className="font-semibold text-gray-700 cursor-pointer" to='/login'><li>Log In</li></Link>
                            <Link className="font-semibold text-gray-700 cursor-pointer" to='/signup'><li>Sign Up</li></Link>
                            <li>
